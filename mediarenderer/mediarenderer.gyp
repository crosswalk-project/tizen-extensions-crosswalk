{
  ...
  'variables': {
    'gen_dbus_proxy_path': '<(SHARED_INTERMEDIATE_DIR)/mediarenderer',
  },
  'targets': [
    {
      'target_name': 'tizen_mediarenderer',
      ...
      'dependencies': [
        'tizen_mediarenderer_gen',
      ],
      'sources': [
        'mediarenderer_api.js',
        'mediarenderer.cc',
        'mediarenderer.h',
        'mediarenderer_extension.cc',
        'mediarenderer_extension.h',
        'mediarenderer_instance.cc',
        'mediarenderer_instance.h',
        'mediarenderer_manager.cc',
        'mediarenderer_manager.h',
      ],
      'includes': [
    ...
    {
      'target_name': 'tizen_mediarenderer_gen',
      'type': 'static_library',
      'variables': {
        'packages': [
          'gio-2.0',
